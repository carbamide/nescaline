...
- (id)init
{
    ...
    if (self != nil) {
        ...
        versionString.text = dict[@"CFBundleVersion"];
...
- (void)setCurrentROMImagePath:(NSString *)_currentROMImagePath
{
    ...
    for (int i = 0; i < 4; i++) {
        gameGenieCodeControl[i].text = gameGenieCodes[[NSString stringWithFormat:@"gameGenieCode%d", i]];
    }
    ...
    if (currentGameName != nil) {
        ...
        if (deleteFile == YES) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                gameGenieCodes[[NSString stringWithFormat:@"gameGenieCode%d", i]] = gameGenieCodeControl[i].text;
            }
