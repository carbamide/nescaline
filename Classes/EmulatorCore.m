...
- (int)applyGameGenieCodes
{
    ...
    if (S.GameGenie) {
        ...
        for (int i = 0; i < 4; i++) {
            NSString *code = gameGenieCodes[[NSString stringWithFormat:@"gameGenieCode%d", i]];
...
{
    EmulatorCore *sharedEmulatorCore = (__bridge EmulatorCore *)userData;
